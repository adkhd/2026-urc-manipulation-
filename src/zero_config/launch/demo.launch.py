...
def generate_launch_description():
    ...
    moveit_config = MoveItConfigsBuilder("zero_arm_urdf", package_name="zero_config").to_moveit_configs()
    ...
    servo_yaml_path = os.path.join(
        get_package_share_directory("zero_config"), "config", "zero_servo.yaml"
    )
