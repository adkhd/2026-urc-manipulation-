...
auto const prompt = [&moveit_visual_tools](auto text) {
  ...
  auto const draw_trajectory_tool_path = [&moveit_visual_tools, jmg = move_group_interface.getRobotModel()->getJointModelGroup("panda_arm")](auto const trajectory) {
...
planning_scene_interface.applyCollisionObject(collision_object);
  ...
  prompt("Press 'Next' in thr RvizVisualToolsGui window to plan");
  draw_title("Planning");
